...
const GOOGLE_OAUTH_URL = (import.meta.env.VITE_API_BASE_URL || 'https://neurohire-backend.onrender.com') + '/auth/login/google-oauth2/?next=/auth/complete/google-oauth2/?role=recruiter';
