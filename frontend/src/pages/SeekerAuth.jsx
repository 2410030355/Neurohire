...
const GOOGLE_OAUTH_URL = (import.meta.env.VITE_API_BASE_URL || 'https://neurohire-backend.onrender.com') + '/auth/login/google-oauth2/?next=/auth/complete/google-oauth2/?role=jobseeker';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const body = tab === 'login'
        ...
        : { email: form.email, password: form.password, full_name: form.full_name, role: 'jobseeker' };
      ...
      >
        ...
        <div className="rounded-3xl overflow-hidden"
          ...
          <div className="px-6 pb-6 pt-4 space-y-3">
            ...
            <InputField icon={Mail} placeholder="student@college.edu" type="email"
